...
public class ReportPath {
    ...
    public static final String RP_ENTERPRISE_INVOICE = PATH+"enterpriseInvoice.jasper";
    public static final String RP_ENTERPRISE_INVOICE_NO_DISCOUNT = PATH+"enterpriseInvoiceNoDiscount.jasper";
    public static final String RP_CHECKSHEET = PATH+"checkSheet.jasper";
